...
func _ready() -> void:
	save.create_or_load_save() # HERE TO SET SAVE VARIABLE FOR SAVE NODE
...
func _on_area_2d_body_entered(body: Node2D) -> void: # MOVING TO NEXT LEVEL
	...
	save.save_game("res://src/main/save_game_example/example_save_level_2.tscn") # SAVES CURRENT SCENE FOR NEXT LEVEL
	save.create_or_load_save() # LOADS THE SCENE
